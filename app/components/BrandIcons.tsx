...
export function UpworkIcon({ className }: IconProps) {
  ...
  return <img src="/logos/upwork.svg" alt="" aria-hidden="true" className={className} />;
}

export function ContraIcon({ className }: IconProps) {
  // eslint-disable-next-line @next/next/no-img-element -- static brand SVG, next/image doesn't optimize SVGs anyway
  return <img src="/logos/contra.svg" alt="" aria-hidden="true" className={className} />;
}

export function LinkedInIcon({ className }: IconProps) {
  // eslint-disable-next-line @next/next/no-img-element -- static brand SVG, next/image doesn't optimize SVGs anyway
  return <img src="/logos/linked.svg" alt="" aria-hidden="true" className={className} />;
}
